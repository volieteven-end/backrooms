...
class UAnimSequence;class USkeletalMeshComponent;
...
public:
    ...
    UPROPERTY(EditAnywhere,BlueprintReadWrite,Category="Backrooms|Arms") FVector EmptyOffset=FVector(3,0,-67.5);
